// ch4_number_cruncher.cpp : Defines the entry point for the console application.
// This program takes in numbers with units
// cm, in, ft or m, converts them to meters,
// sorts them and shows their sequence to the screen
...
int main()
{
	...
	cout << "Please, provide number followed by a unit: cm, in, ft or m" << endl
